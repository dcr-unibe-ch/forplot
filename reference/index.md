...
- [`forplotdata`](https://dcr-unibe-ch.github.io/forplot/reference/forplotdata.md)
  : Demonstration data set with continous outcomes
- [`forplotdata_bp`](https://dcr-unibe-ch.github.io/forplot/reference/forplotdata_bp.md)
  : Raw data for continous outcomes
- [`forplotdata_prop`](https://dcr-unibe-ch.github.io/forplot/reference/forplotdata_prop.md)
